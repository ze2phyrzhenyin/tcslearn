...
description: "Coin flips, balls into bins, and empirical mean concentration."
---
...
Coin flips, balls into bins, and empirical mean concentration.
...
A deterministic simulation summary using fixed seeds.
