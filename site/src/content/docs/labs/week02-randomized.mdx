...
description: "Randomized quicksort, quickselect, Monte Carlo failure, and amplification simulation."
---
...
Randomized quicksort, quickselect, Monte Carlo failure, and amplification simulation.
...
Sorted output and toy failure-rate statistics.
